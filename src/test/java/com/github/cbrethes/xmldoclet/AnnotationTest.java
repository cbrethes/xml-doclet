...
import com.github.cbrethes.xmldoclet.simpledata.Annotation1;
import com.github.cbrethes.xmldoclet.simpledata.Annotation2;
import com.github.cbrethes.xmldoclet.simpledata.Annotation3;
import com.github.cbrethes.xmldoclet.xjc.Annotation;
import com.github.cbrethes.xmldoclet.xjc.AnnotationElement;
...
public class AnnotationTest extends AbstractTestParent {
	...
	public void testAnnotation1() {
		String[] sourceFiles = new String[] { "./src/test/java/com/github/cbrethes/xmldoclet/simpledata/Annotation1.java" };
	...
	public void testAnnotation2() {
		String[] sourceFiles = new String[] { "./src/test/java/com/github/cbrethes/xmldoclet/simpledata/Annotation2.java" };
		Root rootNode = executeJavadoc(null, null, null, sourceFiles, null, new String[] { "-dryrun" });
	...
	public void testAnnotation3() {
		String[] sourceFiles = new String[] { "./src/test/java/com/github/cbrethes/xmldoclet/simpledata/Annotation3.java" };
		Root rootNode = executeJavadoc(null, null, null, sourceFiles, null, new String[] { "-dryrun" });
		...
		assertEquals(element.getQualified(), "com.github.cbrethes.xmldoclet.simpledata.Annotation3.id");
	...
	public void testAnnotation4() {
		String[] sourceFiles = new String[] { "./src/test/java/com/github/cbrethes/xmldoclet/simpledata/Annotation4.java" };
		Root rootNode = executeJavadoc(null, null, null, sourceFiles, null, new String[] { "-dryrun" });
		...
		assertEquals(annotationNode.getQualified(), "com.github.cbrethes.xmldoclet.simpledata.Annotation4");
