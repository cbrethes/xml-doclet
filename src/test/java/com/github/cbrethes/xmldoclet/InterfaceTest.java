...
import com.github.cbrethes.xmldoclet.simpledata.Interface1;
import com.github.cbrethes.xmldoclet.simpledata.Interface2;
import com.github.cbrethes.xmldoclet.simpledata.Interface3;
import com.github.cbrethes.xmldoclet.simpledata.Interface4;
import com.github.cbrethes.xmldoclet.xjc.AnnotationInstance;
import com.github.cbrethes.xmldoclet.xjc.Interface;
...
public class InterfaceTest extends AbstractTestParent {
	...
	public void testInterface1() {
		String[] sourceFiles = new String[] { "./src/test/java/com/github/cbrethes/xmldoclet/simpledata/Interface1.java" };
	...
	public void testInterface2() {
		String[] sourceFiles = new String[] { "./src/test/java/com/github/cbrethes/xmldoclet/simpledata/Interface2.java" };
		Root rootNode = executeJavadoc(null, null, null, sourceFiles, null, new String[] { "-dryrun" });
		...
		assertEquals(method.getQualified(), "com.github.cbrethes.xmldoclet.simpledata.Interface2.method1");
	...
	public void testInterface3() {
		String[] sourceFiles = new String[] { "./src/test/java/com/github/cbrethes/xmldoclet/simpledata/Interface3.java" };
		Root rootNode = executeJavadoc(null, null, null, sourceFiles, null, new String[] { "-dryrun" });
	...
	public void testInterface4() {
		String[] sourceFiles = new String[] { "./src/test/java/com/github/cbrethes/xmldoclet/simpledata/Interface4.java" };
		Root rootNode = executeJavadoc(null, null, null, sourceFiles, null, new String[] { "-dryrun" });
	...
	public void testInterface5() {
		String[] sourceFiles = new String[] { "./src/test/java/com/github/cbrethes/xmldoclet/simpledata/Interface5.java" };
		Root rootNode = executeJavadoc(null, null, null, sourceFiles, null, new String[] { "-dryrun" });
		...
		assertEquals(interfaceNode.getQualified(), "com.github.cbrethes.xmldoclet.simpledata.Interface5");
		...
		assertFalse(method.isSynchronized());
		assertFalse(method.isVarArgs());
		assertEquals(method.getQualified(), "com.github.cbrethes.xmldoclet.simpledata.Interface5.method1");
	...
	public void testInterface6() {
		String[] sourceFiles = new String[] { "./src/test/java/com/github/cbrethes/xmldoclet/simpledata/Interface6.java" };
		Root rootNode = executeJavadoc(null, null, null, sourceFiles, null, new String[] { "-dryrun" });
		...
		assertEquals(interfaceNode.getQualified(), "com.github.cbrethes.xmldoclet.simpledata.Interface6");
		assertEquals(interfaceNode.getScope(), "public");
		assertEquals(interfaceNode.getMethod().size(), 0);
		assertEquals(interfaceNode.getAnnotation().size(), 0);
		assertEquals(interfaceNode.getInterface().size(), 0);
	...
	public void testInterface7() {
		String[] sourceFiles = new String[] { "./src/test/java/com/github/cbrethes/xmldoclet/simpledata/Interface7.java" };
		Root rootNode = executeJavadoc(null, null, null, sourceFiles, null, new String[] { "-dryrun" });
		...
		assertEquals(interfaceNode.getQualified(), "com.github.cbrethes.xmldoclet.simpledata.Interface7");
		assertEquals(interfaceNode.getScope(), "public");
		assertEquals(interfaceNode.getMethod().size(), 0);
		assertEquals(interfaceNode.getAnnotation().size(), 0);
		assertEquals(interfaceNode.getInterface().size(), 0);
	...
	public void testInterface8() {
		String[] sourceFiles = new String[] { "./src/test/java/com/github/cbrethes/xmldoclet/simpledata/Interface8.java" };
		Root rootNode = executeJavadoc(null, null, null, sourceFiles, null, new String[] { "-dryrun" });
		...
		assertEquals(interfaceNode.getQualified(), "com.github.cbrethes.xmldoclet.simpledata.Interface8");
		assertEquals(interfaceNode.getScope(), "public");
		assertEquals(interfaceNode.getMethod().size(), 0);
		assertEquals(interfaceNode.getAnnotation().size(), 0);
		assertEquals(interfaceNode.getInterface().size(), 0);
