...
import com.github.cbrethes.xmldoclet.simpledata.Annotation3;
import com.github.cbrethes.xmldoclet.simpledata.AnnotationCascadeChild;
import com.github.cbrethes.xmldoclet.simpledata.Class1;
import com.github.cbrethes.xmldoclet.simpledata.Class2;
import com.github.cbrethes.xmldoclet.simpledata.Class3;
import com.github.cbrethes.xmldoclet.simpledata.Class4;
import com.github.cbrethes.xmldoclet.simpledata.Class5;
import com.github.cbrethes.xmldoclet.simpledata.Class6;
import com.github.cbrethes.xmldoclet.simpledata.Class7;
import com.github.cbrethes.xmldoclet.simpledata.Class8;
import com.github.cbrethes.xmldoclet.simpledata.Class9;
import com.github.cbrethes.xmldoclet.simpledata.ClassAnnotationCascade;
import com.github.cbrethes.xmldoclet.xjc.AnnotationArgument;
import com.github.cbrethes.xmldoclet.xjc.AnnotationInstance;
import com.github.cbrethes.xmldoclet.xjc.Class;
import com.github.cbrethes.xmldoclet.xjc.Constructor;
import com.github.cbrethes.xmldoclet.xjc.Field;
import com.github.cbrethes.xmldoclet.xjc.Method;
import com.github.cbrethes.xmldoclet.xjc.Package;
import com.github.cbrethes.xmldoclet.xjc.Root;
import com.github.cbrethes.xmldoclet.xjc.TypeInfo;
import com.github.cbrethes.xmldoclet.xjc.TypeParameter;
...
public class ClassTest extends AbstractTestParent {
    ...
    public void testClassAnnotationCascade() {
         String[] sourceFiles = new String[] { "./src/test/java/com/github/cbrethes/xmldoclet/simpledata/ClassAnnotationCascade.java" };
	...
	public void testClass1() {
		String[] sourceFiles = new String[] { "./src/test/java/com/github/cbrethes/xmldoclet/simpledata/Class1.java" };
		Root rootNode = executeJavadoc(null, null, null, sourceFiles, null, new String[] { "-dryrun" });
	...
	public void testClass2() {
		String[] sourceFiles = new String[] { "./src/test/java/com/github/cbrethes/xmldoclet/simpledata/Class2.java" };
		Root rootNode = executeJavadoc(null, null, null, sourceFiles, null, new String[] { "-dryrun" });
	...
	public void testClass3() {
		String[] sourceFiles = new String[] { "./src/test/java/com/github/cbrethes/xmldoclet/simpledata/Class3.java" };
		Root rootNode = executeJavadoc(null, null, null, sourceFiles, null, new String[] { "-dryrun" });
		...
		assertEquals(method.getQualified(), "com.github.cbrethes.xmldoclet.simpledata.Class3.method1");
	...
	public void testClass4() {
		String[] sourceFiles = new String[] { "./src/test/java/com/github/cbrethes/xmldoclet/simpledata/Class4.java" };
		Root rootNode = executeJavadoc(null, null, null, sourceFiles, null, new String[] { "-dryrun" });
	...
	public void testClass5() {
		String[] sourceFiles = new String[] {
				"./src/test/java/com/github/cbrethes/xmldoclet/simpledata/Class5.java",
				"./src/test/java/com/github/cbrethes/xmldoclet/simpledata/Class3.java" };
		Root rootNode = executeJavadoc(null, null, null, sourceFiles, null, new String[] { "-dryrun" });
		...
		assertEquals(classNode.getAnnotation().size(), 0);
		assertEquals(classNode.getInterface().size(), 0);
		assertEquals(classNode.getClazz().getQualified(), "com.github.cbrethes.xmldoclet.simpledata.Class3");
		assertFalse(classNode.isAbstract());
		assertFalse(classNode.isExternalizable());
		assertTrue(classNode.isIncluded());
		assertFalse(classNode.isSerializable());
	...
	public void testClass6() {
		String[] sourceFiles = new String[] { "./src/test/java/com/github/cbrethes/xmldoclet/simpledata/Class6.java" };
		Root rootNode = executeJavadoc(null, null, null, sourceFiles, null, new String[] { "-dryrun" });
	...
	public void testClass7() {
		String[] sourceFiles = new String[] { "./src/test/java/com/github/cbrethes/xmldoclet/simpledata/Class7.java" };
		Root rootNode = executeJavadoc(null, null, null, sourceFiles, null, new String[] { "-dryrun" });
	...
	public void testClass8() {
		String[] sourceFiles = new String[] { "./src/test/java/com/github/cbrethes/xmldoclet/simpledata/Class8.java" };
		Root rootNode = executeJavadoc(null, null, null, sourceFiles, null, new String[] { "-dryrun" });
	...
	public void testClass9() {
		String[] sourceFiles = new String[] { "./src/test/java/com/github/cbrethes/xmldoclet/simpledata/Class9.java" };
		Root rootNode = executeJavadoc(null, null, null, sourceFiles, null, new String[] { "-dryrun" });
	...
	public void testClass10() {
		String[] sourceFiles = new String[] { "./src/test/java/com/github/cbrethes/xmldoclet/simpledata/Class10.java" };
		Root rootNode = executeJavadoc(null, null, null, sourceFiles, null, new String[] { "-dryrun" });
		...
		assertEquals(classNode.getQualified(), "com.github.cbrethes.xmldoclet.simpledata.Class10");
	...
	public void testClass11() {
		String[] sourceFiles = new String[] { "./src/test/java/com/github/cbrethes/xmldoclet/simpledata/Class11.java" };
		Root rootNode = executeJavadoc(null, null, null, sourceFiles, null, new String[] { "-dryrun" });
		...
		assertEquals(classNode.getQualified(), "com.github.cbrethes.xmldoclet.simpledata.Class11");
		assertEquals(classNode.getScope(), "public");
		assertEquals(classNode.getMethod().size(), 0);
		assertEquals(classNode.getField().size(), 0);
		assertEquals(classNode.getAnnotation().size(), 1);
	...
	public void testClass12() {
		String[] sourceFiles = new String[] { "./src/test/java/com/github/cbrethes/xmldoclet/simpledata/Class12.java" };
		Root rootNode = executeJavadoc(null, null, null, sourceFiles, null, new String[] { "-dryrun" });
		...
		assertEquals(classNode.getQualified(), "com.github.cbrethes.xmldoclet.simpledata.Class12");
		assertEquals(classNode.getScope(), "public");
		assertEquals(classNode.getMethod().size(), 0);
		assertEquals(classNode.getField().size(), 0);
		assertEquals(classNode.getAnnotation().size(), 1);
	...
	public void testClass13() {
		String[] sourceFiles = new String[] { "./src/test/java/com/github/cbrethes/xmldoclet/simpledata/Class13.java" };
		Root rootNode = executeJavadoc(null, null, null, sourceFiles, null, new String[] { "-dryrun" });
		...
		assertEquals(classNode.getQualified(), "com.github.cbrethes.xmldoclet.simpledata.Class13");
		assertEquals(classNode.getScope(), "public");
	...
	public void testClass14() {
		String[] sourceFiles = new String[] { "./src/test/java/com/github/cbrethes/xmldoclet/simpledata/Class14.java" };
		Root rootNode = executeJavadoc(null, null, null, sourceFiles, null, new String[] { "-dryrun" });
		...
		assertEquals(classNode.getQualified(), "com.github.cbrethes.xmldoclet.simpledata.Class14");
		assertEquals(classNode.getScope(), "public");
		assertEquals(classNode.getGeneric().size(), 1);
		assertEquals(classNode.getMethod().size(), 0);
		assertEquals(classNode.getField().size(), 0);
	...
	public void testClass15() {
		String[] sourceFiles = new String[] { "./src/test/java/com/github/cbrethes/xmldoclet/simpledata/Class15.java" };
		Root rootNode = executeJavadoc(null, null, null, sourceFiles, null, new String[] { "-dryrun" });
		...
		assertEquals(classNode.getQualified(), "com.github.cbrethes.xmldoclet.simpledata.Class15");
		assertEquals(classNode.getScope(), "public");
		assertEquals(classNode.getGeneric().size(), 1);
		assertEquals(classNode.getMethod().size(), 0);
		assertEquals(classNode.getField().size(), 0);
	...
	public void testClass16() {
		String[] sourceFiles = new String[] {
				"./src/test/java/com/github/cbrethes/xmldoclet/simpledata/Class16.java",
				"./src/test/java/com/github/cbrethes/xmldoclet/simpledata/Annotation3.java" };
		Root rootNode = executeJavadoc(null, null, null, sourceFiles, null, new String[] { "-dryrun" });
	...
	public void testClass17() {
		String[] sourceFiles = new String[] {
				"./src/test/java/com/github/cbrethes/xmldoclet/simpledata/Class17.java",
				"./src/test/java/com/github/cbrethes/xmldoclet/simpledata/Annotation5.java" };
		Root rootNode = executeJavadoc(null, null, null, sourceFiles, null, new String[] { "-dryrun" });
	...
	public void testClass18() {
		String[] sourceFiles = new String[] {
				"./src/test/java/com/github/cbrethes/xmldoclet/simpledata/Class18.java",
				"./src/test/java/com/github/cbrethes/xmldoclet/simpledata/Annotation6.java" };
		Root rootNode = executeJavadoc(null, null, null, sourceFiles, null, new String[] { "-dryrun" });
	...
	public void testClass19() {
		String[] sourceFiles = new String[] {
				"./src/test/java/com/github/cbrethes/xmldoclet/simpledata/Class19.java",
				"./src/test/java/com/github/cbrethes/xmldoclet/simpledata/Annotation7.java",
				"./src/test/java/com/github/cbrethes/xmldoclet/simpledata/Enum1.java" };
		Root rootNode = executeJavadoc(null, null, null, sourceFiles, null, new String[] { "-dryrun" });
		...
		AnnotationInstance instance = classNode.getAnnotation().get(0);
		AnnotationArgument argument = instance.getArgument().get(0);
		assertEquals(argument.getType().getQualified(), "com.github.cbrethes.xmldoclet.simpledata.Enum1");
		assertEquals(argument.getValue().size(), 1);
	...
	public void testClass20() {
		String[] sourceFiles = new String[] {
				"./src/test/java/com/github/cbrethes/xmldoclet/simpledata/Class20.java",
				"./src/test/java/com/github/cbrethes/xmldoclet/simpledata/Annotation8.java" };
		Root rootNode = executeJavadoc(null, null, null, sourceFiles, null, new String[] { "-dryrun" });
	...
	public void testClass21() {
		String[] sourceFiles = new String[] {
				"./src/test/java/com/github/cbrethes/xmldoclet/simpledata/Class21.java",
				"./src/test/java/com/github/cbrethes/xmldoclet/simpledata/Annotation10.java" };
		Root rootNode = executeJavadoc(null, null, null, sourceFiles, null, new String[] { "-dryrun" });
	...
	public void testClass22() {
		String[] sourceFiles = new String[] {
				"./src/test/java/com/github/cbrethes/xmldoclet/simpledata/Class22.java",
				"./src/test/java/com/github/cbrethes/xmldoclet/simpledata/Annotation10.java" };
		Root rootNode = executeJavadoc(null, null, null, sourceFiles, null, new String[] { "-dryrun" });
	...
	public void testClass23() {
		String[] sourceFiles = new String[] {
				"./src/test/java/com/github/cbrethes/xmldoclet/simpledata/Class23.java",
				"./src/test/java/com/github/cbrethes/xmldoclet/simpledata/Annotation11.java" };
		Root rootNode = executeJavadoc(null, null, null, sourceFiles, null, new String[] { "-dryrun" });
	...
	public void testClass24() {
		String[] sourceFiles = new String[] {
				"./src/test/java/com/github/cbrethes/xmldoclet/simpledata/Class24.java",
				"./src/test/java/com/github/cbrethes/xmldoclet/simpledata/Annotation5.java" };
		Root rootNode = executeJavadoc(null, null, null, sourceFiles, null, new String[] { "-dryrun" });
