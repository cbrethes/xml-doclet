...
public class MethodTest extends AbstractTestParent {
	...
	public void testMethod1() {
		String[] sourceFiles = new String[] { "./src/test/java/com/github/cbrethes/xmldoclet/simpledata/Method1.java" };
	...
	public void testMethod2() {
		String[] sourceFiles = new String[] { "./src/test/java/com/github/cbrethes/xmldoclet/simpledata/Method2.java" };
		Root rootNode = executeJavadoc(null, null, null, sourceFiles, null, new String[] { "-dryrun" });
	...
	public void testMethod3() {
		String[] sourceFiles = new String[] { "./src/test/java/com/github/cbrethes/xmldoclet/simpledata/Method3.java" };
		Root rootNode = executeJavadoc(null, null, null, sourceFiles, null, new String[] { "-dryrun" });
